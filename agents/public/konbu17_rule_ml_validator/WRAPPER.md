# Wrapper Notes: konbu17_rule_ml_validator
...
Wrapper action: extracted `submission.py` from `konbu17/orbit-wars-rule-base-ml-shot-validator-hybrid` and stored it as `main.py`.
